...
Game.prototype.display = function(){
	...
	this.ctx.fillText("Alive : "+this.alives+" / "+x, 10, 100);
...
window.onload = function(){
	...
	var start = function(){
		...
		// 	network:[2, [2], 1],
        // });
        Neuvol = new Henrievolution({AF:'sigmoid',Pop:100,Layers:[2,2,1]})
		game = new Game();
		game.start();
		game.update();
		game.display();
